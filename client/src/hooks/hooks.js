...
//accessToken이 있는지 없응지 검사하는 hook함수
...
export const useAuth = () => { //다른데서 사용가능하게 export해줌
  ...
  useEffect(() => {
//로그인이 안된상태 localStorage의 accessToken = null 
